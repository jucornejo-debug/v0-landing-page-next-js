    ...
    <section id="nosotros" className="bg-[#F6EFE6] py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          {/* Left: Text */}
          <div>
            <h2 className="font-sans font-bold text-3xl md:text-4xl text-[#8B1E24] uppercase mb-8 tracking-tight">
              QUIENES
              <br />
              SOMOS
            </h2>

            <div className="space-y-6 font-serif text-base md:text-lg text-[#333333] leading-relaxed">
              <p>
